...
async fn main(spawner: Spawner) {
        ...
        .pwrite(
            DeauthenticationFrame {
                header: ManagementFrameHeader {
                    ...
                    // receiver_address: [0xee, 0x12, 0x6e, 0x58, 0x86, 0x3e].into(),
    ...
    let buffer = [
        ...
        /*  4 - 9  */
        // 0xEE, 0x12, 0x6E, 0x58, 0x86, 0x3E, // reciever (target)
        0x10, 0x3F, 0x44, 0xF6, 0x88, 0xF7, // reciever (target)
        /* 10 - 15 */
...
// 0xa0, 0x00, 0x00, 0x00, 0x10, 0x3f, 0x44, 0xf6, 0x88, 0xf7, 0x52, 0x78, 0x7d,
// 0x52, 0xb8, 0x14, 0xdc, 0x39, 0x6f, 0x0d, 0x44, 0x3b, 0x00, 0x00, 0x04,
